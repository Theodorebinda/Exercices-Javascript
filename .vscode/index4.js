...
const readingList = [
  ...
  },
 {
  ...
  },
  {
    ...
    auteur : "Napolleon Hill",
    dejaLu : true
  },
  {
    titre : "Reflechissez Devenez Riche",
    auteur : "Napolleon Hill",
    dejaLu : true
  }
...
readingList.forEach(element => {
  livreLu = element.titre + " de" + " "+ element.auteur ;

  if(readingList[3].dejaLu){
    console.log(element + " Deja lu");
  } else{
    console.log(element + " Vous devez encore lire ");
  }
});
